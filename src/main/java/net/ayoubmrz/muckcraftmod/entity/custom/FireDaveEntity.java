...
public class FireDaveEntity extends HostileEntity implements GeoEntity, IShootable {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    private static final TrackedData<Boolean> IS_SHOOTING = DataTracker.registerData(FireDaveEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private int shootingTicks = 0;
    private final String TEXTUREPATH = "textures/entity/red_ball.png";

    public FireDaveEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    private PlayState shootPredicate(AnimationState<FireDaveEntity> event) {
    ...
    private PlayState predicate(AnimationState<FireDaveEntity> animationState) {
